...
namespace NOVAAPP.Pages.Rutas
{
    public class EditarModel : PageModel
    {
        ...
        public EditarModel(ICrudApi<RutasViewModel, int> service, ICrudApi<FlotillaViewModel, int> serviceF)
        {
        ...
        public async Task<IActionResult> OnGetAsync(int id)
        {
            try
            {
                ...
                Ruta = await service.ObtenerPorId(id);
                Ruta.Costos = Convert.ToDecimal(Ruta.Costos);
