...
namespace NOVAAPP.Pages.Asientos
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(ICrudApi<AsientosViewModel, int> service, ICrudApi<UsuariosViewModel, int> serviceU, ICrudApi<SucursalesViewModel, string> sucursales, ICrudApi<CuentasBancariasViewModel, int> cuentas)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(Roles1.Where(a => a == "60").FirstOrDefault()))
                {
