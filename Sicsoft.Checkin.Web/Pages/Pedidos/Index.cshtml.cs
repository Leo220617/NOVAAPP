...
namespace NOVAAPP.Pages.Pedidos
{
    public class IndexModel : PageModel
    {
        ...
        private readonly ICrudApi<PedidosViewModel, int> service;
        ...
        [BindProperty]
        public PedidosViewModel[] Listas { get; set; }
        ...
        public IndexModel(IConfiguration configuration, ICrudApi<PedidosViewModel, int> service, ICrudApi<UsuariosViewModel, int> serviceU, ICrudApi<RolesViewModel, int> roles, ICrudApi<SucursalesViewModel, string> sucursales)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(Roles1.Where(a => a == "120").FirstOrDefault()))
                {
