...
namespace NOVAAPP.Pages.ReporteVendedoresVentas
{
    public class Index2Model : PageModel
    {
        ...
        public Index2Model(ICrudApi<ReporteVentasVendedoresViewModel, int> service, ICrudApi<VendedoresViewModel, int> vendedores, ICrudApi<SucursalesViewModel, string> sucursales)
        {
