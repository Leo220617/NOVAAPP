...
namespace NOVAAPP.Pages.Aprovisionamiento
{
    public class EditarModel : PageModel
    {
        ...
        public EditarModel(ICrudApi<AprovisionamientoProductosViewModel, int> aprovisionamientoProductos, ICrudApi<AprovisionamientoViewModel, int> service, ICrudApi<CategoriasViewModel, int> categorias, ICrudApi<SubCategoriasViewModel, int> subCategorias, ICrudApi<BodegasViewModel, int> bodegas) //CTOR 
        {
