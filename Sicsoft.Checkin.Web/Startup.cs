...
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
     ...
     .AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
            ...
            services.AddRefitClient<ICrudApi<EncComprasViewModel, int>>()
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/OrdenesCompra"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();

            services.AddRefitClient<ICrudApi<BitacoraMinimosViewModel, int>>()
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/BitacoraMinimos"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
...
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
            ...
            services.AddRefitClient<ICrudApi<UsuariosBodegasViewModel, int>>()
...
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
            ...
            services.AddRefitClient<ICrudApi<EncRelacionadosViewModel, int>>()
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/Relacionados"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();

            services.AddRefitClient<ICrudApi<EstadoCuentaViewModel, int>>()
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/EstadoCuenta"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
...
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
            ...
            services.AddRefitClient<ICrudApi<FamiliasViewModel, int>>()
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/Familias"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();

            services.AddRefitClient<ICrudApi<InventarioGeneralViewModel, int>>()
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/Reportes/InventarioGeneral"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();

            services.AddRefitClient<ICrudApi<InventarioGeneralOrdenesViewModel, int>>()
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/Reportes/InventarioGeneralOrdenes"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();

            services.AddRefitClient<ICrudApi<ReporteVentasVendedoresViewModel, int>>()
.ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/ReporteVentasVendedores"))
.AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
